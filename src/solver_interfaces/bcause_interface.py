...
def bcause_solver(uai_path: str, csv_path: str, treatment_variable: str, outcome_variable: str, mapping: dict):
    ...
    print(
        f'P({outcome_variable}=1|do({treatment_variable}=0)) = {[p_do0.values[1], p_do0.values[3]]}')
    print(
        f'P({outcome_variable}=1|do({treatment_variable}=1)) = {[p_do1.values[1], p_do1.values[3]]}')
    print('ATE                          = ',
