...
# For running this sequentialy and avoiding problems with random generator
...
@pytest.mark.parametrize("label,expected",
                         [("modelTestA_1",
                           [0.5783249936269131, 0.27823307599470376,
                            0.7217669240052962, 0.4216750063730869]),
                          ("modelTestB_1",
                           [0.46011788201489945, 0.5398821179411604,
                            0.46011788205883963, 0.5398821179851006])
                          ]
                         )
...
@pytest.mark.parametrize("label,expected",
                         [("modelTestA_1",
                           [0.5454061540437741, 0.22976323371809068,
                            0.7702367662819094, 0.45459384595622593]),
                          ("modelTestB_1",
                           [0.5299653323117544, 0.47003466763566476,
                            0.5299653323643353, 0.47003466768824564])
                          ]
                         )
...
@pytest.mark.parametrize("label,expected",
                         [("modelTestA_1",
                           [0.3177723822046544, 0.042492679529959027,
                            0.27250968537176334, 0.00442204181161961,
                            0.4991739879978861, 0.2238942846877377,
                            0.45391129129598834, 0.18582364710039156]),
                          ("modelTestB_1",
                           [0.3187933044410842, 0.0025505259961731406,
                            0.25705787797551244, 0.009037333607844486,
                            0.5250737834472572, 0.20883100495041307,
                            0.4633383570006582, 0.2153178125810572]
                           )
                          ]
                         )
...
@pytest.mark.parametrize("label,expected",
                         [("modelTestA_1", -1489.024653062976),
                          ("modelTestB_1", -1410.1130382420752)]
                         )
